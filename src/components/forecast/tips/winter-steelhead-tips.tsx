...
import { getSeasonLabel, getCurrentYear } from "@/lib/utils/dateUtils";
  ...
  return (
    <div className="text-sm">
      <p className="font-medium text-blue-700 dark:text-blue-300">
        Winter Steelhead - {seasonLabel} Season (Dec 1 - March 31)
      </p>
      ...
      <div className="mt-2 p-2 bg-amber-100 dark:bg-amber-900/30 rounded border border-amber-300 dark:border-amber-700">
        <p className="text-amber-800 dark:text-amber-200 font-medium text-xs">
          ⚠️ {year} DROUGHT ALERT: Pacific NW at 50% normal precipitation (similar to 2001, 2015, 2021)
        </p>
      ...
      <ul className="mt-2 list-disc list-inside text-muted-foreground">
        <li>
          <strong>WDFW {seasonLabel} Coastal Regulations:</strong> Most major rivers open Dec 1 - March 31. Notable exceptions: Humptulips closes Feb 2, Chehalis closes Feb 16.
        </li>
        <li>
        ...
        <li>
          <strong>🌊 DROUGHT TACTICS ({year}):</strong> Downsize to 6-8lb fluorocarbon. Use 1/16-1/8oz jigs in darker colors (black, purple). Target "broken water" - riffles and tailouts where steelhead feel secure in low visibility.
        </li>
        <li>
        ...
        <li>
          <strong>Must Release:</strong> Wild steelhead required to be released on most Washington coastal rivers per {seasonLabel} regulations.
        </li>
      </ul>
    </div>
  );
