...
import { FeaturedGearPicks } from "./forecast/FeaturedGearPicks";
    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent>
          ...
          {/* Featured Gear Picks — contextual to today's species */}
          {forecast.recommendations.length > 0 && (
            <FeaturedGearPicks
              species={forecast.recommendations.map(r => r.species)}
              date={today}
            />
          )}
