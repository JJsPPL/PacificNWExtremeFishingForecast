...
export const GEAR_BY_SPECIES: Record<string, SpeciesGearProfile> = {
  ...
  halibut: {
    essentials: [
      {
        name: "Heavy Duty Fishing Rod 5'6\"-6'6\" Extra-Heavy",
        category: 'rod',
        description: 'Short, stout rod for hauling big fish from depth',
        priceRange: '$80-$250',
        amazonUrl: amazonSearch('heavy duty fishing rod extra heavy 6 foot deep sea'),
      },
      {
        ...
        priceRange: '$80-$300',
        amazonUrl: amazonSearch('conventional fishing reel deep sea 40 size'),
      },
      {
        ...
        priceRange: '$20-$40',
        amazonUrl: amazonSearch('braided fishing line 65lb deep sea'),
      },
    ],
    recommended: [
      {
        name: 'Heavy Jigs (8-16oz)',
        category: 'lure',
        description: 'Heavy leadhead jigs with curly tail or swimbaits',
        priceRange: '$8-$20',
        amazonUrl: amazonSearch('deep sea jig 16oz heavy leadhead'),
      },
      {
        ...
        priceRange: '$5-$12',
        amazonUrl: amazonSearch('circle hook 10/0 deep sea fishing'),
      },
      {
        name: 'Spreader Bar / Bottom Rig',
        category: 'terminal',
        description: 'Bottom fishing rig with dual hooks and bait clip',
        priceRange: '$8-$15',
        amazonUrl: amazonSearch('spreader bar bottom rig deep sea fishing'),
      },
    ],
  },
  ...
  sturgeon: {
    essentials: [
      {
        name: "Heavy Duty Fishing Rod 7'-9' Extra-Heavy",
        category: 'rod',
        description: 'Heavy backbone for 100lb+ fish from the bank or boat',
        priceRange: '$80-$250',
        amazonUrl: amazonSearch('heavy duty fishing rod extra heavy 8 foot river'),
      },
      {
        ...
        priceRange: '$80-$300',
        amazonUrl: amazonSearch('large conventional fishing reel heavy duty'),
      },
      {
        name: '80-100lb Braided Line',
        category: 'line',
        description: 'No-stretch braid for feeling subtle bites in current',
        priceRange: '$20-$40',
        amazonUrl: amazonSearch('braided fishing line 80lb heavy duty'),
      },
    ],
    recommended: [
      {
        name: 'Heavy Bottom Rig (sliding sinker, bead, swivel)',
        category: 'terminal',
        description: 'Heavy sinker (6-24oz), bead, barrel swivel, 24" leader',
        priceRange: '$5-$15',
        amazonUrl: amazonSearch('heavy bottom fishing rig sliding sinker leader'),
      },
      {
        name: 'Circle Hooks (7/0-10/0)',
        category: 'terminal',
        description: 'Required for catch-and-release — better hookups',
        priceRange: '$5-$10',
        amazonUrl: amazonSearch('circle hook 8/0 heavy duty fishing'),
      },
    ],
  },
