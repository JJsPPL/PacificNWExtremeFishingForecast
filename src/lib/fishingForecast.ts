...
const LOCATION_DETAILS = {
  ...
  "Columbia River - Mouth to Longview": "Famous Buoy 10 fishery to Longview. Excellent fall Chinook and coho salmon fishing.",
  "Columbia River - Longview to Bonneville": "Great summer steelhead and spring Chinook fishing. Walleye fishing around islands.",
  "Columbia River - Bonneville to The Dalles": "Trophy sturgeon, smallmouth bass, and salmon fishing near dam tailraces.",
  "Columbia River - The Dalles to McNary": "Prime walleye and bass water with salmon runs through gorge sections.",
  "Columbia River - Astoria to Portland": "Lower river tidewater section with excellent salmon and sturgeon fishing.",
  "Columbia River - Portland to Hood River": "Middle river section with diverse fisheries and tributary mouths.",
